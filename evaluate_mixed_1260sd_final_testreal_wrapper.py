#!/usr/bin/env python3
"""评估 Mixed (1260 SD Conservative Final) 模型 - Test_Real"""
...
sys.argv = [
    ...
    '--ckpt', 'baseline/runs/mixed_ws4000_sd1260_conservative_final/ckpt_best.pth',
    '--index_csv', 'dataset/woodscape_processed/meta/labels_index_ablation.csv',
    '--img_root', '.',
    '--split_col', 'split',
    '--test_split', 'test',
    '--global_target', 'S_full_wgap_alpha50',
    '--out_dir', 'baseline/runs/mixed_ws4000_sd1260_conservative_final',
]
